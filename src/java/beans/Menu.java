...
public class Menu implements Serializable {
    ...
    public void buildMenu() {
        ...
        // Index view
        leaves.add(new MenuLeaf("/ameg/index.jsf", msg.getString("menu.index")));
        
        MenuController controller = (MenuController)FacesContext.getCurrentInstance() 
        ...
        */
        ...
        // help
        leaves.add(new MenuLeaf("/ameg/about.jsf", msg.getString("menu.about")));
        leaves.add(new MenuLeaf("/ameg/help.jsf", msg.getString("menu.help")));
